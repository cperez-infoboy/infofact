...
# v3: sanitizacion de data-URIs en plaintext (sesion-14): los parses viejos con
# base64 embebido quedaron con chunks kilometricos; subir la version los refresca.
_PARSE_SCHEMA_VERSION = "3"
